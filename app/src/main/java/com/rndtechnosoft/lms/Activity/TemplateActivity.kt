...
class TemplateActivity : AppCompatActivity() {
    ...
    private lateinit var AddTemplateButton: AppCompatButton
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       AddTemplateButton= findViewById(R.id.addTemplate_button)
        ...
        AddTemplateButton.setOnClickListener {
            val intent = Intent(this@TemplateActivity, EditTemplateActivity::class.java)
                    ...
                    .enqueue(object : Callback<GetTemplateResponse> {
                        override fun onResponse(
                            ...
                            if (response.isSuccessful) {
                                ...
                                adapter = TemplateAdapter(LeadList, this@TemplateActivity)
